...
As you can see from the test accuracy results CNN-s perform better than normal Deep Neural networks on image processing, however, they are pretty accurate as well. 
